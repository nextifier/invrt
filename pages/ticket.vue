      ...
      >
        ...
        <div class="lg:col-span-6 px-4 lg:pl-0">
          <div class="flex flex-col items-start lg:pt-8">
            ...
            <div class="mt-16 flex flex-col items-start">
              <span class="text-white uppercase tracking-[0.4em]"
                >VIP Packages</span
              >
              ...
              <p class="mt-6">
                For detailed information and VIP reservation, please reach us on
              ...
              <a
                ...
                target="_blank"
                class="px-6 py-6 bg-gray-900 hover:bg-gray-800 transition-colors duration-300 mt-4 flex items-center gap-x-3"
                v-wave
              >
                <svg
                  class="h-7"
...
<script>
import LogoTraveloka from "~/components/LogoTraveloka.vue";
export default {
  head() {
    return {
